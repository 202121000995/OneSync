...
```text
clients\win7-qt\dist\OneSyncWin7-win7-qt-v1.14\OneSyncWin7.exe
clients\win7-qt\dist\OneSyncWin7-win7-qt-v1.14.zip
```
...
clients/win7-qt/dist/OneSyncWin7-win7-x86-v1.14.zip
```
